...
/// evidencia real detrás de cada punto; se llegó a esta versión DESPUÉS de probar y
/// descartar dos variantes más agresivas):
...
///    midió desde ~10s hasta más de 4 minutos en corridas distintas). Se probó primero
...
///    encima podía agregar minutos a la suite sin resolver el solapamiento). Ambos
///    enfoques se DESCARTARON a propósito, en este orden, tras medirlos -- ver esa
///    evidencia completa en el reporte. Un Ryuk "viejo" que ya terminó su propio
///    handshake y está bajando solo NO compite por CPU/Docker de la misma forma que uno
///    recién arrancado, así que ese solapamiento residual (Ryuk viejo inactivo + Ryuk
///    nuevo arrancando) no reproduce el mecanismo real de la falla -- a diferencia del
///    estado SIN este lock, donde sí podían coexistir DOS handshakes activos.
///
